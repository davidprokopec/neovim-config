...
--     local open_router_api_key = os.getenv("OPEN_ROUTER_API_KEY")
--
...
--     vim.keymap.set({ "n", "v" }, "<leader>O", openai_help, { desc = "llm openai_help" })
--     vim.keymap.set({ "n", "v" }, "<leader>o", openai_replace, { desc = "llm openai" })
